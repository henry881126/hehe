...
//     data.map(menu => {
//       let component = menu.url
//       let routerObj = {
//         path: menu.path,
//         name: menu.path.replace(/\//g, ''),
//         meta: { title: menu.name, icon: menu.css},
//         hidden: menu.hidden
//       }
//       if (menu.url.toLowerCase() === "layout"){
//         routerObj.component = layout
//       }else{
//         if (component.indexOf("?") !== -1){
//           let index = component.lastIndexOf("?")
//           let iframeInf = {
//             id: menu.path.replace(/\//g, ''),
...
//         let parentPath = menu.path.indexOf("/") === 0 ? menu.path : '/' + menu.path
//         let curPath = menu.subMenus[0].path.indexOf("/") === 0 ? menu.subMenus[0].path : '/' + menu.subMenus[0].path
